...
public abstract class FiveBitsData extends AbstractSensorData {
    ...
    public String toString() {
        ...
        return String.format("[%s] = [%s = %s, %s = %s, %s = %s, %s = %s, %s = %s]", getPacketName(), parameterNames[0], nullOrStr(parameters[0]),
                parameterNames[1], nullOrStr(parameters[1]), parameterNames[2], nullOrStr(parameters[2]), parameterNames[3], nullOrStr(parameters[3]),
